...
describe('recipes', function () {
  ...
  // closing server; this will run after the test code
  after(function () {
    return closeServer();
  });
  ...
  it('should post recipes', function () {
    const newItem = { name: 'chai tea', ingredients: 'milk, tea, ice' };
    return chai.request(app)
      .post('/recipes')
      .send(newItem)
      .then(function (res) {
